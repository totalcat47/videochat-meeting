...
export default function Page() {
  ...
  const faqs = [
    {
      question: "Рейтинг",
      answer:"Рейтинг може мати значення від 1 до 5. Чим вище, тим краще. Зелений колір означає, що рейтинг високий, чорний – середній, червоний – низький. Рейтинг формується з оцінок Преміум-користувачів на основі середнього арифметичного. Рейтинг дозволяє зрозуміти, чи подобається співрозмовникам спілкування з вами. Якщо рейтинг став низьким, це означає, що багатьом користувачам спілкування з вами не сподобалося, і вони поставили негативну оцінку. Важливо пам’ятати, що рейтинг суб’єктивний, так само як і оцінки користувачів.",
    },
  ];
